...
export default async function AddTaskPage({
  ...
  return (
    <div className="flex flex-col justify-center min-h-[80vh] space-y-10 max-w-2xl mx-auto animate-in fade-in duration-500">
      <div className="mb-6">
        <Link href="/dashboard/tasks">
          <Button variant="ghost" className="pl-0 text-zinc-500">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Tulis apa yang perlu lo kerjain.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {/* TAMPILIN ERROR DISINI KALAU ADA */}
          {error && (
          ...
          <form action={createTask} className="grid gap-6">
            <div className="grid gap-2">
              ...
              <Input id="title" name="title" placeholder="Contoh: Fix bug" />
            </div>
